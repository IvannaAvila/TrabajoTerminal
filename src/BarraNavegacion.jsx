      ...
      <div className="w-full container mx-auto p-6">
        ...
        <div className="w-full flex items-center justify-between">
          <Link title='INICIO' to='/' className="inline-block text-gray-500 no-underline hover:text-black hover:text-underline text-center h-10 p-2 md:h-auto md:p-4">
            <img src={logo} alt='logo' className='w-20 md:w-40 opacity-90 hover:opacity-100' />
          </Link>
          <div className="flex w-1/2 justify-end content-center">
            ...
            <a className="md:block hidden inline-block text-gray-500 no-underline hover:text-black hover:text-underline text-center h-10 p-2 md:h-auto md:p-4" data-tippy-content="@twitter_handle" href="https://www.instagram.com/iv_reyna/?fbclid=IwAR0ffrIeitN13Ba2Ttbx6DVsZSB4e3ilo5Yg3BAV0yReJ4wIOEeew0eGSeQ">
            ...
            <a className="md:block hidden inline-block text-gray-500 no-underline hover:text-black hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 " data-tippy-content="#facebook_id" href="https://www.facebook.com/alan.albertc?locale=es_LA">
